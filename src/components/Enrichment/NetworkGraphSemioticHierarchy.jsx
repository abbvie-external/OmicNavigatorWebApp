...
const frameProps = {
  ...
  //   hierarchyChildren: d => d.children // Function describing how children are defined in the hierarchical dataset, which will be passed as the second value to d3-hierarchy’s hierarchy function
  // },
  networkType: { type: 'partition', projection: 'radial' },
  nodeIDAccessor: 'name',
  nodeStyle: d => ({
    fill: theme[d.depth],
...
const customSimulation = d3.forceSimulation().force(
  'charge',
  d3
    .forceManyBody()
    .distanceMax(100)
...
export default () => {
  return (
    <NetworkFrame
      edges={networkDataNew.clusters[0].links}
      networkType={{
        type: 'force',
        iterations: 500,
