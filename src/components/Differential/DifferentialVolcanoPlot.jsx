...
class DifferentialVolcanoPlot extends React.PureComponent {
  ...
  hexBinning(data, breadCrumb = false, breadCrumbIndex = 0, reset = false) {
    ...
    if (reset || breadCrumb) {
      this.props.onHandleVolcanoPlotSelectionChange(data, true);
    }
    ...
    const endBrush = function() {
      ...
      if (d3.event.selection != null) {
        ...
        if (!!total.length) {
          ...
          // self.props.onHandleVolcanoPlotSelectionChange(total);
        }
        ...
        //   });
        // }
        // self.props.onHandleVolcanoPlotSelectionChange(brushedDataArr);
