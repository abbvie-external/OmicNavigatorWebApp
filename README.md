Test of Slack Integration (TODO: Update this Readme)
...
[Source map Navigator](https://www.npmjs.com/package/source-map-Navigator) analyzes
JavaScript bundles using the source maps. This helps you understand where code
bloat is coming from.

To add Source map Navigator to a Create React App project, follow these steps:

```sh
npm install --save source-map-Navigator
```

Alternatively you may use `yarn`:

```sh
yarn add source-map-Navigator
```
...
```diff
   "scripts": {
+    "analyze": "source-map-Navigator build/static/js/main.*",
     "start": "react-scripts start",
     "build": "react-scripts build",
     "test": "react-scripts test --env=jsdom",
```
